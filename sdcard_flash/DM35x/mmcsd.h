 ...
 *                                                                          *
 * ------------------------------------------------------------------------ */
#define MMCSD_BASE              0x01E11000
#define MMCSD_MMCCTL            *( volatile Uint32* )( MMCSD_BASE + 0x00 )
#define MMCSD_MMCCLK            *( volatile Uint32* )( MMCSD_BASE + 0x04 )
#define MMCSD_MMCST0            *( volatile Uint32* )( MMCSD_BASE + 0x08 )
#define MMCSD_MMCST1            *( volatile Uint32* )( MMCSD_BASE + 0x0C )
#define MMCSD_MMCIM             *( volatile Uint32* )( MMCSD_BASE + 0x10 )
#define MMCSD_MMCTOR            *( volatile Uint32* )( MMCSD_BASE + 0x14 )
#define MMCSD_MMCTOD            *( volatile Uint32* )( MMCSD_BASE + 0x18 )
#define MMCSD_MMCBLEN           *( volatile Uint32* )( MMCSD_BASE + 0x1C )
#define MMCSD_MMCNBLK           *( volatile Uint32* )( MMCSD_BASE + 0x20 )
#define MMCSD_MMCNBLC           *( volatile Uint32* )( MMCSD_BASE + 0x24 )
#define MMCSD_MMCDRR            *( volatile Uint32* )( MMCSD_BASE + 0x28 )
#define MMCSD_MMCDXR            *( volatile Uint32* )( MMCSD_BASE + 0x2C )
#define MMCSD_MMCCMD            *( volatile Uint32* )( MMCSD_BASE + 0x30 )
#define MMCSD_MMCARGHL          *( volatile Uint32* )( MMCSD_BASE + 0x34 )
#define MMCSD_MMCRSP_BASE       ( MMCSD_BASE + 0x38 )
#define MMCSD_MMCRSP01          *( volatile Uint32* )( MMCSD_BASE + 0x38 )
#define MMCSD_MMCRSP23          *( volatile Uint32* )( MMCSD_BASE + 0x3C )
#define MMCSD_MMCRSP45          *( volatile Uint32* )( MMCSD_BASE + 0x40 )
#define MMCSD_MMCRSP67          *( volatile Uint32* )( MMCSD_BASE + 0x44 )
#define MMCSD_MMCDRSP           *( volatile Uint32* )( MMCSD_BASE + 0x48 )
#define MMCSD_MMCCIDX           *( volatile Uint32* )( MMCSD_BASE + 0x50 )
#define MMCSD_SDIOCTL           *( volatile Uint32* )( MMCSD_BASE + 0x64 )
#define MMCSD_SDIOST0           *( volatile Uint32* )( MMCSD_BASE + 0x68 )
#define MMCSD_SDIOIEN           *( volatile Uint32* )( MMCSD_BASE + 0x6C )
#define MMCSD_SDIOIST           *( volatile Uint32* )( MMCSD_BASE + 0x70 )
 ...
 *  FIFO LEVEL
 */
#define MMCSD_FIFOLEVEL_16BYTES 0   // MMCSD_FIFO Levelzero ( 16 bytes )
#define MMCSD_FIFOLEVEL_32BYTES 1   // MMCSD_FIFO LevelOne ( 32 Bytes )
