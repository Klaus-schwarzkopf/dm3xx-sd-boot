...
#define PLL0_CONFIG         *( volatile Uint32* )( SYSTEM_BASE + 0x84 )
#define PLL1_CONFIG         *( volatile Uint32* )( SYSTEM_BASE + 0x88 )
 ...
 *  Function Renaming                                                       *
 * ------------------------------------------------------------------------ */
#define EVMDM365_wait          _wait
#define EVMDM365_waitusec      _waitusec
...
Int16 EVMDM365_init( );
Uint16 EVMDM365_CPLD_rget(Int16 regnum);
void EVMDM365_CPLD_rset(Int16 regnum, Uint8 regval);
