...
typedef struct _DEVICE_GPIO_REGS_
{
  ...
  VUint32 DIR02;          //0x38
  VUint32 OUTDATA02;            //0x3C
  VUint32 SETDATA02;         //0x40
  VUint32 CLRDATA02;       //0x44
  VUint32 INDTATA02;       //0x48
//  VUint32 SETRIS02;        //0x4C
//  VUint32 CLRRIS02;              //0x50
//  VUint32 SETFAL02;         //0x54
//  VUint32 CLRFAL02;       //0x58
//  VUint32 INTSTAT02;      //0x5c
}
DEVICE_GPIORegs;
...
Uint32  DEVICE_PLL2Init_temp(void);
Uint32  DEVICE_PLL1Init_temp(Uint32 PllMult);
Uint32  DEVICE_DDR2Init_temp(void);
